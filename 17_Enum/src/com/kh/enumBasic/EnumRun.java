...
import com.kh.enumBasic.Day2.Day3.Day4;

public class EnumRun {
	/*
	 * Enum => Enumeration(열거)의 약자형.
	 * 기존에 사용하던 상수를 정의하는 방법중 final static과 같은 기능함.
	 * 문자열 혹은 숫자들을 나타내는 기본자료형을 Enum을 통해서 표현할수있다.
	 * 
	 * 
	 * 1 -> true, true, -> true, "Y" -> true
	 * 
	 * 1 -> 일반 게시판, 2 -> 썸네일 게시판, 3 -> xxx게시판
	 */
	public static final String MONDAY = "MON";
	public static final String TUESDAY = "TUE";
	public static final String WEDNESSDAY = "WEN";
	 ...
	 * 3) monday라는 문자열 을 저장하고 싶을 경우 -> 새롭게 선언해줘야함.
	 * 4) 상수필드가지고 반복문을 통해 값을 가져올 수 없음.
	 * 
	 */
	
	enum EnumTest {
		MONDAY, // static , final 키워드를 붙히지 않았는데 자동으로 추가해줌.
		TUESDAY,
		WEDNESDAY,
		THURSDAY,
		FRIDAY,
