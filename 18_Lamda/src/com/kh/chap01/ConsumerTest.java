...
public class ConsumerTest {
	...
	static IntConsumer c2 = (point) -> System.out.println("현재 귀하의 잔고는 "+point+"원 입니다.");
	...
	// 4) ObjXXXConsumer<T> : T타입인자 1개 + XXX타입의 인자값 1개를 가짐.
	...
	public static void main(String[] args) {
		c1.accept("갤럭시 z플립4");
		c2.accept(40000);
		c3.accept("갤력시 z플립4",1350000);
		c4.accept(new Product("갤력시 z플립4",0,1),1350000);
