...
//		hong.height = 166,6;
		 ...
		 * 그러면 직접적인 접근을 막은경우 간접적으로나마 접근할수 있는 방법?
		 * settet / getter 
		 */
		// setter메서드 호출
		hong.setName("홍길동");
