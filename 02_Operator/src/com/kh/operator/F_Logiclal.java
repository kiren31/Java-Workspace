...
public class F_Logiclal {
	 ...
	 * 
	 * OR 연산자 :  논리값 || 논리값
	 * 			   왼쪽, 오른쪽 논리값 중 어느하나라도 TRUE 면 최종결과가 TRUE
	 *  
	 */
	...
	public void method2() {
		...
		// 사용자가 입력한 값이 1이상 100이하 입니까 ? thue/false
	...
	public void method4() {
		 ...
		 * 실행할대 오류는 나지 않지만, result1의 결과값이 어차피 false인데 왜 작성한 구문인지 물어보는것.
		 */
