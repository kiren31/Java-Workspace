...
public class User {
	...
	public User() {
		 ...
		 * 기본 생성자를 생략하는 경우 => 오류나지않음.
		 * JVM이 클래스를 컴파일할때 기본생성자 없는 경우 항상 자동으로 만들어주기 때문.(매개변수 있는 생성자가 없는 경우)
		 * 단, 매개변수가 있는 생성자가 이미 클래스 안에 작성되어 있는 경우 반드시 기본 생성자도 함께 작성해줘야한다.
	...
	public User(String userId, String userPwd, String userName, int age,char gender) {
		...
		/*
		 * 생성자 내부에서 생성자끼리 중복되는 코드가 있는 경우, this 생성자를 통해 같은 클래스 내에 있는 다른 생성자
