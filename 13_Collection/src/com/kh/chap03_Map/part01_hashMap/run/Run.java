...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 1. 저장순서 유지 X
		// 2. value 값이 동일하다고해도, key값이 중복되지 않기 때문에 잘 저장됨.
		...
		Snack s = hm.get("칸쵸"); // 제네릭설정을 해놨기 때문에 Snack타입 객체로 강제형변환 하는 과정이 생략되었다.
		...
		// 1) hm에 있는 key + value 값 모두 (Entry) set에 담기 (Entry 집합형태)
