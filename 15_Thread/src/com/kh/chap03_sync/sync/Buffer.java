...
public class Buffer {
	...
	private boolean empty = true; // 플래그 변수(객체의 상태를 저장하고 흐름을 제어하기 위한 변수)
	/*
	 * synchronized (격리공간으로 지정).
	 * - 동기화 메소드, 동기화 블럭에 사용되는 키워드
	 * - 동기화 메소드는 메소드 선언에 synchronized 키워드를 붙히고 인스턴스, 정적메소드 어디든 사용 가능하다.
	...
	public synchronized void getData() {
		...
		// notify() : wait()에 의해 정지된 스레드중 한개를 실행 대기상태로 만드는것.
		notify();
	}
